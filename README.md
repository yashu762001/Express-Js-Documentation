<h3> The react native application is made using the expo client. Expo client makes it easy for debugging the code and see how the application looks on the actual mobile phone. </h3>
